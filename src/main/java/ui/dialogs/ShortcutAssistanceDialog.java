...
public class ShortcutAssistanceDialog extends JDialog {
    ...
    private void initComponents() {
        ...
        Object[][] data = {
            ...
            {"Ctrl + S", "Save project"},
            {"Delete", "Delete selected object (Point, Line, Grid)"},
            {"Space (Hold)", "Temporary Hand Tool (Pan image)"},
            {"A", "Select Tool (When Zoom Window hidden)"},
            ...
            {"L", "Line Tool (Draw custom free lines)"},
            {"P / B", "P2P Tool (Measure distances / Draw lines)"},
            {"M / Ctrl + M", "Toggle Zoom Window (Caliper mode)"},
            {"Arrow Keys", "Move selected point by 1px (if point selected)"},
            {"", ""},
            {"[ ZOOM WINDOW ]", ""},
            {"Arrow Keys", "Set label direction (North, South, East, West)"},
            {"A", "Toggle Custom Label Mode (with target circle)"},
            {"X", "Cycle XOR background color"},
            {"ESC", "Disable custom label placement mode"},
            ...
            {"Ctrl + E", "Delete All measurement lines (P2P Tool)"},
